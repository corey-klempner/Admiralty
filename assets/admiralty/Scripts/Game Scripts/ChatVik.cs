...
public class ChatVik : Photon.MonoBehaviour
{
	...
	private static int statisticsHeight = (int)Screen.width/4;
    ...
    {        
        ...
        GUILayout.BeginArea(new Rect(0, Screen.height - chatHeight - statisticsHeight, Screen.width, chatHeight));
